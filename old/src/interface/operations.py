    ...
    if nb2 != nb3:
        ...
        for i in range(nb1):
            for j in range(nb4):
                ...
                prod[i][j] = Button(root_produit, text=produit[i][j], relief="groove", width=4, height=1,
...
def operation_stockmorse(mat, n):
    ...
    for i in range(n):
        for j in range(n):
            if float(mat[i][j].get()) != 0.0:
                indiceligne[x] = Button(root_morse, text=i, width=4, height=1, relief="groove",
                                        font="/font/myfont 9",
                                        bg="#eee")
                indicecolonne[x] = Button(root_morse, text=j, width=4, height=1, relief="groove",
                                          font="/font/myfont 9",
                                          bg="#eee")
                elmtnonnul[x] = Button(root_morse, text=mat[i][j].get(), width=4, height=1, relief="groove",
                                       font="/font/myfont 9",
                                       bg="#eee")
    ...
    for i in range(n, 0, -1):
        for j in range(0, i):
            if mat[i][j + 1] != 0.0:
                ...
                sign *= -1
    determinant = Button(root_det, text=round(sign * proddiag(mat, n1), 2), relief="groove", width=6,
...
def operation_transposee(mat1, n):
    ...
    for a in range(n):
        for b in range(n):
            trans[a][b] = Button(root_trans, text=mat[b][a], relief="groove", width=4, height=1,
...
def operation_gauss(mat, vect, n):
    ...
    if matrice[n - 1][n - 1] == 0:
        ...
        t = t2 + t4
        for s in range(n):
            solution[s] = Button(root_gauss, text=round(x[s], 4), relief="groove", width=6, height=1,
                                 font="/font/myfont 9 bold",
                                 bg="#eee")
...
def operation_lu(mat, vect, n):
    ...
    if l != 0:
        ...
        for i in range(n):
            for j in range(n):
                matrice_l[i][j] = Button(root_lu, text=round(l[i][j], 4), relief="groove", width=6, height=1,
                                         font="/font/myfont 9 bold", bg="#eee")
                matrice_u[i][j] = Button(root_lu, text=round(u[i][j], 4), relief="groove", width=6,
