...
def saisie_2matrices(window, canvas):
    canvas.create_text(250, 20,
                        text="Nombre de lignes 1, Nombre de colonnes 1 ",
                        font="/font/myfont 10 ",
                        fill="#00F5FF"
                    )
    canvas.create_text(250, 60, text="Nombre de lignes 2, Nombre de colonnes 2 ",
                        font="/font/myfont 10 ",
                        fill="#00F5FF"
                    )
    ligne1 = Entry(window,
    ...
    col1.pack()
    col2.pack()
    bouton_ok = Button(window,
                        text="Ok",
                        relief="groove",
                        font="/font/myfont 6 ",
                        command=lambda: affiche_saisie_2matrices(window, canvas, ligne1.get(), col1.get(), ligne2.get(), col2.get(), bouton_ok),
                        bg="#eee",
                        fg="black",
...
def saisie_1matrice(window, canvas, saiz):
    canvas.create_text(300, 20,
                        text="Nombre de lignes et de colonnes ",
                        font="/font/myfont 10 ",
                        fill="#00F5FF"
                    )
    ligne = Entry(window,
...
def affiche_saisie_1matrice(window, canvas, n, bouton):
    try:
        ...
        bouton_ok = Button(window,
                            ...
                            width=2,
                            relief="groove",
                            command=lambda: affiche_boutons_operations1matrice(canvas, case, n, bouton_ok)
                        )
        canvas.create_text(20, 100 + (35 * n / 2) - 20,
                            text="A=",
                            font="/font/myfont 13",
                            fill="#00F5FF"
                        )
...
def affiche_saisie_2matrices(window, canvas, a, b, c, d, bouton):
    try:
        ...
        bouton_ok = Button(window,
                            text="Ok",
                            relief="groove",
                            command=lambda: affiche_boutons_operation2matrices(canvas, case1, case2, a, b, c, d, bouton_ok),
                            bg="#eee",
                            fg="black",
                            activebackground="#dcc",
                            font="/font/myfont 6 ",
        ...
        canvas.create_text(20, 100 + (30 * a / 2) - 20,
                            text="A = ",
                            font="/font/myfont 13",
                            fill="#00F5FF"
                        )
        canvas.create_text(800, 100 + (30 * a / 2) - 20,
                            text="B = ",
                            font="/font/myfont 13",
                            fill="#00F5FF"
                        )
        canvas.create_window(1400 + 50 + 30 * a, 100 + (30 * a / 2) - 20, window=bouton_ok)
    except ValueError:
...
def affiche_saisiesyslin(window, canvas, n1, bouton):
    try:
        ...
        bouton_ok = Button(window,
                            ...
                            width=3,
                            relief="groove",
                            command=lambda: affiche_bouton_operationssyslin(canvas, case, vecteur, n, bouton_ok)
                        )
        canvas.create_text(20, 100 + (35 * n / 2) - 20,
                            text="A = ",
                            font="/font/myfont 13",
        ...
        canvas.create_text(180 + 35 * (n - 1) - 20, 100 + (35 * n / 2) - 20,
                            text="B = ",
                           font="/font/myfont 13",
                           fill="#00F5FF"
                        )
...
def affiche_bouton_operationssyslin(canvas, mat, vect, n, bouton):
    ...
    bouton.destroy()
    bouton_gauss = Button(root,
                            command=lambda: operation_gauss(mat, vect, n),
    ...
    bouton_lu = Button(root,
                        command=lambda: operation_lu(mat, vect, n),
    ...
    canvas.create_window(dimx_ / 2 - 150, 100 + 35 * n + 30, window=bouton_gauss)
    canvas.create_window(dimx_ / 2 + 150, 100 + 35 * n + 30, window=bouton_lu)
...
def affiche_boutons_operations1matrice(canvas, mat, n, bouton):
    ...
    bouton.destroy()
    morse = Button(root,
                    text="Stockage morse matrice",
                    command=lambda: operation_stockmorse(mat, n),
                    relief="groove",
                    font="/font/myfont 11 ",
                    bg="#eee",
                    fg="black",
    ...
    inverser = Button(root,
                        text="    Inverse d'une matrice",
    ...
    determinant = Button(root,
                            text="   Determinant matrice     ",
                            command=lambda: operation_determinant(mat, n),
                            relief="groove",
                            font="/font/myfont 11 ",
                            bg="#eee",
                            fg="black",
    ...
    trans = Button(root,
                    text="    Transposee matrice      ",
                    command=lambda: operation_transposee(mat, n),
                    relief="groove",
                    font="/font/myfont 11 ",
...
def affiche_boutons_operation2matrices(canvas, mat1, mat2, a, b, c, d, bouton):
    ...
    produit = Button(root,
                        text="Produit",
                        command=lambda: operation_produit(mat1, mat2, a, b, c, d),
                        relief="groove",
                        font="/font/myfont 12 ",
                        bg="#eee",
                        fg="black",
    ...
    somme = Button(root,
                    text="Somme",
                    command=lambda: operation_somme(mat1, mat2, a, b, c, d),
                    relief="groove", font="/font/myfont 12 ",
                    bg="#eee",
                    fg="black",
                    activebackground="#dcc"
                )
    canvas.create_window(dimx_ / 2 - 150, 250 + 35 * a, window=somme)
    canvas.create_window(dimx_ / 2 + 150, 250 + 35 * a, window=produit)
